...
import time
import yaml
from mmsm_train_2 import BanditNet, MultiArmedBanditEnv 
...
parser.add_argument('--rlsave', type=str, default='./mmsm_model/mmsm_170.pth', help='save path')
...
if __name__ == '__main__':
    ...
    while data != None:
        ...
        data, cache = env.steptest(action=action, newcache=cache)
