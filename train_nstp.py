...
from utils.mdtp import MyDataset_nstp, set_seed
...
def main():
    ...
    bike_train_data = MyDataset_nstp(bikevolume_train_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    taxi_train_data = MyDataset_nstp(taxivolume_train_save_path, args.window_size, args.batch_size, args.pad,  args.pred_size)
    bike_adj_data = MyDataset_nstp(bikeflow_train_save_path, args.window_size, args.batch_size, args.pad,  args.pred_size)
    taxi_adj_data = MyDataset_nstp(taxiflow_train_save_path, args.window_size, args.batch_size, args.pad,  args.pred_size)
    ...
    bike_valid_data = MyDataset_nstp(bikevolume_valid_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    taxi_valid_data = MyDataset_nstp(taxivolume_valid_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    bike_valid_adj_data = MyDataset_nstp(bikeflow_valid_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    taxi_valid_adj_data = MyDataset_nstp(taxiflow_valid_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
