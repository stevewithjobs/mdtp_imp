...
from models.model import NetMoe, Net_timesnet, Net_timesnet_moe, Net_timesnet_moe_nstp, Net_timesnet_nstp, Net_timesnet_smoe_timesnet, Net_timesnet_smoe_onetimesnet
...
parser.add_argument('--save', type=str, default='/home_nfs/haitao/data/web_host_network/mdtp_moe/log_2024-10-19_03-10-06/_epoch_106_0.0119.pth', help='save path')
# 消融实验 无残差
...
def main():
    ...
    bike_test_data = MyDataset_nstp(bikevolume_test_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    taxi_test_data = MyDataset_nstp(taxivolume_test_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    bike_adj_data = MyDataset_nstp(bikeflow_test_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    taxi_adj_data = MyDataset_nstp(taxiflow_test_save_path, args.window_size, args.batch_size, args.pad, args.pred_size)
    ...
    model = Net_timesnet_smoe_onetimesnet(args.batch_size, args.window_size, args.node_num, args.in_features, args.out_features, args.lstm_features, base_smoe_config, args.pred_size)
